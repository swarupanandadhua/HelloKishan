...
const String STRING_BUYING_FROM = 'কেনা হচ্ছে'; // 'Buying from';
...
const String STRING_SELLING_TO = 'বিক্রি হচ্ছে'; // 'Selling to';
...
const String STRING_ACCEPT = 'গ্রহণ করুন'; // ACCEPT'
const String STRING_REJECT = 'প্রত্যাখ্যান করুন'; // REJECT'
const String STRING_CANCEL = 'বাতিল করুন'; // 'CANCEL';
const String STRING_COMPLETE = 'সফল হয়েছে'; // 'COMPLETE';
